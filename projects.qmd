...
Least squares is often used, so this method can be applied to many other applications in live settings, allowing the model to be updated as data flows in.
 ...
 Parallelization and Game Theory

[Parallelization and Game Theory](Projects/parallelisering.qmd)

In this project, I look at resource allocation on a shared Linux server through the lens of game theory. Framing parallelization as a Nash equilibrium problem turns out to be a surprisingly natural fit.
I ran simulations to see how the equilibrium holds up under different conditions.
