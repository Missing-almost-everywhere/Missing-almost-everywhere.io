...
# Models
I start by using some simple models, where I rely on intuition and examine the residuals. 
Then, I move on to more advanced techniques. 
First, I’m going to plot some models, analyze the residuals, and compare them to other variables. 
I like to start this way because it gives me an intuitive understanding of the data. 
Models built this way have the advantage of being easy to explain, which is helpful if someone wants to trade some predictive strength for better explainability. 
Personally, I still prioritize evaluating the models based on out-of-sample predictive strength, preferably using cross-validation.
